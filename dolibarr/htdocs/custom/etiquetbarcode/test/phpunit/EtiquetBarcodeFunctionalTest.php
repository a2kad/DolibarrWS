...
/**
 * \file    test/phpunit/EtiquetBarcodeFunctionalTest.php
...
/**
 * Class EtiquetBarcodeFunctionalTest
 *
 ...
 *
 * @package Testetiquetbarcode
 */
class EtiquetBarcodeFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modEtiquetBarcode')->click();
		} else {
			// Disable the module
			$this->byHref('modEtiquetBarcode')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/etiquetbarcode/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('etiquetbarcode/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/etiquetbarcode/admin/about.php');
		$this->authenticate();
		return $this->assertContains('etiquetbarcode/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('etiquetbarcodewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modEtiquetBarcode_EtiquetBarcodeTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modEtiquetBarcode_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
