...
/**
 *  \file       core/modules/etiquetbarcode/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_etiquet
 */
class pdf_standard_etiquet extends ModelePDFEtiquet
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_ETIQUET_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->etiquetbarcode->dir_output.'/etiquet') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->etiquetbarcode->dir_output.'/etiquet';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->etiquetbarcode->dir_output.'/etiquet/'.$objectref;
