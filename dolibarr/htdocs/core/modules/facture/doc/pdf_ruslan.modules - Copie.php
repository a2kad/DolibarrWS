...
class pdf_ruslan extends ModelePDFFactures
{
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($showaddress) {
			...
			//$pdf->setXY($posx + 2, $posy); // fixe les positions x et y courantes
			//$pdf->SetTextColor(0,0,200); // fixe la couleur du texte
			//$pdf->SetFont('','B', $default_font_size); // fixe la police, le type ( 'B' pour gras, 'I' pour italique, '' pour normal,...)
