...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_ruslan.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate customers invoices from ruslan model
 */
...
/**
 *	Class to generate the customer invoice PDF with template Ruslan
 */
class pdf_ruslan extends ModelePDFFactures
{
	 /**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "ruslan";
		$this->description = $langs->trans('PDFRuslanDescription');
	...
	protected function _tableau_tot(&$pdf, $object, $deja_regle, $posy, $outputlangs, $outputlangsbis)
	{
		...
		$useborder = 0;
		$index = 0;
		$name_of_code_barre = $outputlangs->convToOutputCharset($object->ref); //Get nomber of invoice (facture)
	...
	{
		/*//Add the notes - Eta nadpis nastraivaetsya v lichnom kabinete - zakomentiroval
		$pdf->SetXY(10, 280);
		$pdf->SetTextColor(0, 0, 60);
